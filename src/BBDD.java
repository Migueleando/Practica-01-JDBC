...
public class BBDD {
	...
	/**
	 * Metodo que recibe un objeto pregunta y 4 respuestas (en nuestro juego siempre hay 4 respuestas) y los añada a la base de datos
	 * @param pregunta
	 * @param respuesta1
	 * @param respuesta2
	 * @param respuesta3
	...
	public void AñadirPregunta (Pregunta pregunta, Respuesta respuesta1, Respuesta respuesta2, Respuesta respuesta3, Respuesta respuesta4) {		
		...
		// Insertamos en las tablas
		    ...
		    PreparedStatement preparedStmtPregunta = con.prepareStatement(queryQUESTION);
		    IdPregunta++;
		    ...
		    PreparedStatement preparedStmtRespuesta1 = con.prepareStatement(queryANSWER1);
		    IdRespuesta++;
		    ...
		    PreparedStatement preparedStmtRespuesta2 = con.prepareStatement(queryANSWER2);
		    IdRespuesta++;
		    ...
		    PreparedStatement preparedStmtRespuesta3 = con.prepareStatement(queryANSWER3);
		    IdRespuesta++;
		    ...
		    PreparedStatement preparedStmtRespuesta4 = con.prepareStatement(queryANSWER4);
		    IdRespuesta++;
